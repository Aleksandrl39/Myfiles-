(function(){
    ...
    function search(params = {}, oncomplite){
        ...
        network.silent(url, (json)=>{
            ...
            if (json && typeof json === "object") {
                ...
                // Добавляем тестовую карточку для диагностики
                results.push({
                    id: "test-123",
                    title: "Тестовая карточка",
                    original_title: "Test Card",
                    release_date: "2025-01-01",
                    release_year: "2025",
                    poster_path: "https://via.placeholder.com/300x450?text=Test+Image",
                    backdrop_path: "https://via.placeholder.com/300x450?text=Test+Image",
                    poster: "https://via.placeholder.com/300x450?text=Test+Image",
                    img: "https://via.placeholder.com/300x450?text=Test+Image",
                    description: "Это тестовая карточка для проверки",
                    overview: "Категория: Тест",
                    info: "Категория: Тест | Скачиваний: 100",
    ...
    // Логируем список доступных источников
    console.log("Available discovery sources:", Lampa.Api.availableDiscovery());
