(function () {
    ...
    function cleanTitle(title) {
        return title
            ...
            .replace(/(CD|LP|FLAC|MP3|AAC|lossless|tracks|cue|WEB|DVD|HD|Remastered|Original US Pressing)/gi, "") // Убираем лишние технические термины
            .replace(/\d{4}/g, "") // Убираем года
            .replace(/( - |, |: )/g, " ") // Убираем лишние разделители
            .trim();
    }
