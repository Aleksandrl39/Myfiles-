(function () {
    ...
    function createSearchPage() {  
        ...
        var jsonOutput = document.createElement("pre");  
        jsonOutput.style.marginTop = "20px";  
        jsonOutput.style.padding = "10px";  
        jsonOutput.style.background = "#222";  
        jsonOutput.style.color = "#0f0";  
        ...
        function renderList(items) {
            ...
            jsonOutput.textContent = JSON.stringify(items, null, 2); // Выводим JSON в pre-блок
        ...
        searchInput.addEventListener("keypress", function (event) {  
            if (event.key === "Enter") {  
                ...
                jsonOutput.textContent = "Ожидание ответа API...";
