(function () {
    ...
    function createSearchPage() {
        ...
        resultsContainer.style.height = "calc(100vh - 100px)"; // Учитываем заголовок и поиск
        resultsContainer.style.overflowY = "auto";
        resultsContainer.style.marginTop = "10px";
        resultsContainer.style.paddingRight = "10px";
        resultsContainer.style.paddingBottom = "20px"; // Чтобы последняя запись не обрезалась        
