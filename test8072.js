                ...
                categories.forEach(category => {
                    if (json.hasOwnProperty(category) && Array.isArray(json[category])) {
                        json[category].forEach(item => {
                            ...
                            let poster = item.Poster && item.Poster.trim() ? item.Poster : 'https://via.placeholder.com/300x450?text=No+Image';
                            ...
                            let resultItem = {
                                ...
                                poster_path: poster, // Используем постер или заглушку
                                backdrop_path: poster, // Используем тот же постер для фона
                                poster: poster,
                            ...
                            console.log("Processed result:", resultItem); // Логируем каждую карточку
