(function () {
    ...
    return title
        ...
        .replace(/(FLAC|MP3|AAC|320 kbps|256 kbps|lossless|cue|tracks|WEB|CD|LP|DVD|Remastered|Original|US Pressing|[0-9]{4})/gi, "")  // Убираем лишние термины и год
        .replace(/[^a-zA-Zа-яА-ЯёЁ0-9\s]/g, "")  // Убираем лишние символы
        .split(" - ")[0]  // Берем только первую часть названия
        .trim();
}
