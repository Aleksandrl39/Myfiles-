            ...
            artists.forEach(artist => {
                ...
                item.addEventListener("click", function () {
                    ...
                    getAlbums(artist.artistName).then(albums => {
                        resultsContainer.innerHTML = "";
                        if (albums.length === 0) {
                            resultsContainer.innerHTML = "<div class='search__not-found'>Альбомы не найдены.</div>";
                            return;
                        }
                            ...
                            albumItem.addEventListener("click", function () {
                                ...
                                searchTorrents(artist.artistName, album.collectionName).then(torrents => {
                                    ...
                                    if (torrents.length === 0) {
                                        resultsContainer.innerHTML = "<div class='search__not-found'>Торренты не найдены.</div>";
                                        return;
                                    }
