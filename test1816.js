(function () {
    ...
    var rutrackerApiUrl = "https://rutracker-api.vercel.app/api/v1/search";
    ...
    function searchRutracker(query) {
        return fetchData(`${rutrackerApiUrl}?query=${encodeURIComponent(query)}`)
            .then(data => data?.results || []);
    }
    ...
    function createSearchPage() {
        ...
        function renderTorrents(torrents) {
            ...
            torrents.forEach(torrent => {
                ...
                seeds.innerHTML = `Сидов: ${torrent.seeds} / Личеров: ${torrent.leeches}`;
                ...
                renderList(artists, artist => {
                    ...
                    getAlbums(artist.name).then(albums => {
                        renderList(albums, album => {
                            ...
                            resultsContainer.innerHTML = "<p>Поиск на Rutracker...</p>";
                            searchRutracker(searchQuery).then(torrents => {
